...
def load_gui(self):
    ...
    self.btn_add = tk.Button(self.master, width=12, height=2, text='Submit',
                             command=lambda: studenttracker_func.addToList(self))
    ...
    self.btn_update = tk.Button(self.master, width=12, height=2, text='Update',
                                command=lambda: studenttracker_func.onUpdate(self))
    ...
    self.btn_delete = tk.Button(self.master, width=12, height=2, text='Delete',
                                command=lambda: studenttracker_func.onDelete(self))
    ...
    self.btn_close = tk.Button(self.master, width=12, height=2, text='Close',
                               command=lambda: studenttracker_func.ask_quit(self))
